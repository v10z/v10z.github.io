(function () {
  ...
  Streams.Effect.Replace = function () {
  ...
  Streams.Effect.Replace.prototype = _.extend(new Streams.Effect(), {
  ...
  var replace = new Streams.Effect.Replace();
  Streams.Effects.push(replace);
